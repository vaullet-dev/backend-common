/**
 * The error vocabulary shared by every {@code @vaullet-dev} backend service.
 *
 * <p>Everything here is deliberately free of the web stack. A service layer throws in domain terms;
 * translating that into an HTTP response is {@code common-web}'s job, and happens once. That
