...
import dev.vaullet.common.web.ApiExceptionHandler;
import dev.vaullet.common.web.WebAutoConfiguration;
...
/**
 * Wires the platform security posture. Adding {@code common-security} is the installation
 * step.
 *
