 ...
 * authorisation the moment a second entry point is added. That is not hypothetical on this platform:
 * ADR-004's revised flow settles and releases from a Kafka listener, which never passes through a
 * filter chain at all.
 */
